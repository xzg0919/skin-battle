package com.tzj.green.api.util;


import com.alibaba.fastjson.JSONObject;
import com.tzj.green.param.FilesBean;
...
public class UtilApi {
    ...
    @AuthIgnore 
    //@RequiresPermissions(values = ALI_API_COMMON_AUTHORITY)
    public Object uploadImageTwo(FilesBean filesBean){
        System.out.println("----------------------开始上传图片了------------------");
        return fileUploadServiceImpl.handleUploadField("", filesBean.getHeadImg());
    }
