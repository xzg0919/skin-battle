package com.skin.common.security;
...
public class MD5Util {
	...
	public static String SIGN_KEY="406F7E4343204436A059B65AAAEA6097";
	/***
	 * 生成32位md5的HEX码
	 */
	...
	public static void main(String[] args) {
		System.out.println(UUID.randomUUID().toString().replace("-", "").toUpperCase().replace("o", "0").replace("i", "1"));
