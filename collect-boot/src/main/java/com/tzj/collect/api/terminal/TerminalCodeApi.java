...
public class TerminalCodeApi {
    ...
    public Object saveEnterpriseCode(EnterpriseCodeBean enterpriseCodeBean)throws ApiException {
    ...
    @SignIgnore
    @RequiresPermissions(values = TERMINAL_API_COMMON_AUTHORITY)
    public Object getEnterpriseCodeDetal(EnterpriseCodeBean enterpriseCodeBean)throws ApiException {
