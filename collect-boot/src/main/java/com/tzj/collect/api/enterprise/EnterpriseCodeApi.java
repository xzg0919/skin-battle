...
public class EnterpriseCodeApi {
    ...
    public Object enterpriseCodeList(EnterpriseCodeBean enterpriseCodeBean) throws ApiException {
    ...
    @SignIgnore
    @RequiresPermissions(values = ENTERPRISE_API_COMMON_AUTHORITY)
    public Object enterpriseCodeDetil(EnterpriseCodeBean enterpriseCodeBean) throws ApiException {
