...
public class EnterpriseProductApi extends Exception {
    ...
    public Object updateEnterpriseProduct(EnterpriseProductBean enterpriseProductBean) throws Exception {
    ...
    @RequiresPermissions(values = ENTERPRISE_API_COMMON_AUTHORITY)
    @DS("slave")
    public Object EnterpriseProductList(EnterpriseProductBean enterpriseProductBean) throws Exception {
        EnterpriseAccount enterpriseAccount = EnterpriseUtils.getEnterpriseAccount();
