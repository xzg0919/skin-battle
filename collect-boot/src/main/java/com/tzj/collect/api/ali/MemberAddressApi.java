...
public class MemberAddressApi {
    ...
    public MemberAddress memberAddress(MemberAddressBean memberAddressBean) {
        ...
        if (null == memberAddress) {
            ...
            memberAddress.setFullAddress("请选择地址");
        } else {
            memberAddress.setFullAddress(memberAddress.getProvinceName()
                    + memberAddress.getCityName() + memberAddress.getAreaName()
                    + memberAddress.getStreetName() + memberAddress.getAddress());
        }
