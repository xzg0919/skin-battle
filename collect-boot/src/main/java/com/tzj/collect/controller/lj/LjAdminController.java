...
public class LjAdminController {
    ...
    public @ResponseBody List<Area>  getAreaList(LjAdminBean ljAdminBean){
    ...
    public @ResponseBody List<Area>  getStreetList(LjAdminBean ljAdminBean){
    ...
    public @ResponseBody Map<String,Object> getYwDateDetail(LjAdminBean ljAdminBean){
        //注册总用户数量
