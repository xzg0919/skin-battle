...
public class UtilController {
     ...
     * 上传文件0
     */
    @RequestMapping("/util/uploadImage")
    public Object uploadImage(FileBase64Param file, HttpServletRequest request) throws Exception {
