...
public interface AliFlcxService {
     ...
     com.alipay.api.response.AlipayIserviceCognitiveClassificationFeedbackSyncResponse lexCheckFeedBack(String traceId, String imageUrl, String feedbackRubbish, String actionType);
     //异步上传至标注平台
