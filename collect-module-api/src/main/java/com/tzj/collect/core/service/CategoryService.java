...
public interface CategoryService extends IService<Category> {
	...
	*/
	...
	boolean updatePrice(ComIdAndCateOptIdBean comIdAndCateOptIdBean) throws Exception;

	boolean updateLocalePrice(ComIdAndCateOptIdBean comIdAndCateOptIdBean) throws Exception;
	/**
	 * 获取分类属性所有价格及当前价格
	 * @param categoryBean
	 * @param string
	...
	@DS("slave")
	BigDecimal getPricesAll(String aliUserId, long categoryId, String type, String categoryAttrOptionIds);
	@DS("slave")
