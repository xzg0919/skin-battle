 ...
 * @version        1.0
 */
@TableName("sb_voucher_member")
public class VoucherMember extends DataEntity<Long>
{
	private static final long serialVersionUID = -5430971499748254324L;
    /**
     * 主键
     */
    ...
    /**
     * <p>Description:[获取会员阿里id]</p>
     * @return String aliUserId
     */
