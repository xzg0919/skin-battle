...
import com.tzj.collect.core.mapper.PiccInsurancePolicyMapper;
import com.tzj.collect.core.param.picc.PiccInsurancePolicyAgreementBean;
import com.tzj.collect.core.param.picc.PiccInsurancePolicyBean;
import com.tzj.collect.core.param.picc.PiccInsurancePolicyContentBean;
...
public class PiccInsurancePolicyServiceImpl extends ServiceImpl<PiccInsurancePolicyMapper, PiccInsurancePolicy> implements PiccInsurancePolicyService {
    ...
    @Transactional
    @Override
    public Object updateInsurance(Long piccCompanyId, PiccInsurancePolicyBean piccInsurancePolicyBean) throws Exception {
