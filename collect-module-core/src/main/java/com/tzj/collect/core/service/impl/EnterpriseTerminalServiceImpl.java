...
import com.tzj.collect.core.mapper.EnterpriseTerminalMapper;
...
public class EnterpriseTerminalServiceImpl extends ServiceImpl<EnterpriseTerminalMapper, EnterpriseTerminal> implements EnterpriseTerminalService {
    ...
    @Override
    @Transactional
    public Object updateEnterpriseTerminal(EnterpriseTerminalBean enterpriseTerminalBean, Integer enterpriseId) throws Exception {
